...
interface ParentFixture {
    ...
    boolean entityDenied(ServerPlayer player,net.minecraft.world.entity.Entity target,boolean attack);
    void transfer(ServerPlayer oldOwner,ServerPlayer newOwner,int x,int z);
    void claimDimension(ServerPlayer owner,net.minecraft.resources.ResourceKey<net.minecraft.world.level.Level> dimension,int x,int z);
}
